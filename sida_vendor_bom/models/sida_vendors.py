...
class BoMTemplate(models.Model):
    ...
    def get_data(self,bom_id):
        ...
        for component in components:
            record = []
            _logger.debug("Aggregating data for component %s"%component.product_id.name)
            ...
            vendors = self.env['product.supplierinfo'].search([('product_tmpl_id','=',component.product_id.id)])
